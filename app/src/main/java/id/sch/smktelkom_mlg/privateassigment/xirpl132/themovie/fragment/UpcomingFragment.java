...
import id.sch.smktelkom_mlg.privateassigment.xirpl132.themovie.model.UpcomingResponse;
...
public class UpcomingFragment extends Fragment {
    ...
    ArrayList<Upcoming> mList = new ArrayList<>();
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = (RecyclerView) getView().findViewById(R.id.upcoming);
        StaggeredGridLayoutManager layoutManager =
                new StaggeredGridLayoutManager(1, StaggeredGridLayoutManager.VERTICAL);
        recyclerView.setLayoutManager(layoutManager);
        mupcomingAdapter = new UpcomingAdapter(this.getActivity(), mList);
    ...
    private void downloadDataSources() {
        String url = "https://api.themoviedb.org/3/movie/upcoming?api_key=25b1b63ecfba8aed739100ca353e9344&language=en-US&page=1";
